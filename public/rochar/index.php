...
//- Sql
Controller::$hostname =     "194.104.156.10"          ;   // Mysql Host
Controller::$database =     "xro"           ;   // Database Name
Controller::$username =     "xro"           ;   // Database Username
Controller::$password =     "zRr-9&XYu7JiTe:"           ;   // Database Pass
/// -----------------------------------------------------------------
